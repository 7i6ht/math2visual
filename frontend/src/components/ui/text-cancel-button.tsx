...
export function TextCancelButton({ label, onClick, ariaLabel, className }: TextCancelButtonProps) {
  return (
    <button
      ...
      className={cn(
        "group flex items-center gap-1 sm:gap-1.5 md:gap-2 lg:gap-2.5 xl:gap-3 2xl:gap-3.5 3xl:gap-4 4xl:gap-5 5xl:gap-6",
        "text-gray-300 hover:text-destructive bg-transparent border-none transition-all duration-200",
        "text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl cursor-pointer",
        className
      )}
    >
