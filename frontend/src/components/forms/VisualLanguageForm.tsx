...
export const VisualLanguageForm = ({ 
  ...
  return (
    <div className="flex flex-col h-full visual-language-form">
      <h2 className="text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl 3xl:text-6xl 4xl:text-7xl 5xl:text-8xl font-bold mb-3 flex-shrink-0">Visual Language</h2>
