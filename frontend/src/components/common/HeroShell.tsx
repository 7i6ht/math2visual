      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-1.5rem)] sm:min-h-[calc(100vh-2rem)] lg:min-h-[calc(100vh-2rem)] xl:min-h-[calc(100vh-2rem)] 2xl:min-h-[calc(100vh-2rem)] 3xl:min-h-[calc(100vh-2rem)] 4xl:min-h-[calc(100vh-2rem)] 5xl:min-h-[calc(100vh-2rem)]">
        <div className="w-full max-w-sm sm:max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-6xl 3xl:max-w-6xl 4xl:max-w-7xl 5xl:max-w-8xl 6xl:max-w-[60%] px-2 sm:px-0">
          <div className="text-center space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-4 xl:space-y-6 2xl:space-y-8 3xl:space-y-10">
            ...
            <p className="text-muted-foreground text-sm sm:text-base md:text-lg lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl 6xl:text-[3.5rem] w-full max-w-full mx-auto leading-relaxed font-medium">
              {subtitle}
            </p>
          </div>

          <div className="mt-6 3xl:mt-12">{children}</div>
        </div>
      </div>
    </div>
  );
