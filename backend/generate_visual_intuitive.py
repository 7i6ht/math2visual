...
class IntuitiveVisualGenerator:
    ...
    def extract_visual_language(self, text):
        """
    ...
    def is_int(self, value):
        try:
            ...
            return False
    def handle_division(self, operations, containers, svg_root, resources_path,result_containers,start_x = 50 ,start_y = 150):
        ...
        if not self.is_int(dividend_entity["item"].get("entity_quantity", 0)) or not self.is_int(divisor_entity["item"].get("entity_quantity", 1)):
    ...
    def handle_surplus(self, operations, containers, svg_root, resources_path,result_containers,start_x = 50 ,start_y = 150):
    ...
    def handle_comparison(
        ...
        for i in range(2):
            ...
            if all(op["entity_type"] in ["addition", "subtraction"] for op in operations_i):
                ...
                try:
                    created, w, h = self.handle_tvq_final(operations_i,containers_i,svg_root,resources_path,result_i,start_x=current_x,start_y=current_y)
                except:
                    return
                ...
                print("Handling multiplication")
                try:
                    created, w, h = self.handle_multiplication(
                    operations_i,
                    containers_i,
                    svg_root,
                    resources_path,
                ...
                print("Handling division")
                try:
                    created, w, h = self.handle_division(
                    operations_i,
                    containers_i,
                    svg_root,
                    resources_path,
                ...
                print("Handling surplus")
                try:
                    created, w, h = self.handle_surplus(
                        operations_i,
                        containers_i,
                        svg_root,
                        resources_path,
                ...
                try:
                    created, w, h = self.handle_tvq_final(
                    operations_i,
                    containers_i,
                    svg_root,
                    resources_path,
        ...
        # draw balance scale
        self.draw_balance_scale(svg_root, entity_boxes)

        # return True, str(float(svg_root.attrib["width"]) - start_x), str(float(svg_root.attrib["height"]) - MARGIN + 15)
        return created, svg_root.attrib["width"], svg_root.attrib["height"]
        

    def draw_balance_scale(self, svg_root, entity_boxes):
        """
    ...
    # main function:
    def handle_tvq_final(self, operations, containers, svg_root, resources_path, result_containers,start_x = 50,start_y = 150):
        print("Handling tvq_final")
        # Constants
        UNIT_SIZE = 40
        APPLE_SCALE = 0.75
    ...
    def handle_area(self, operations, containers, svg_root, resources_path, result_containers,start_x = 100,start_y = 100):
        print("Handling area")
